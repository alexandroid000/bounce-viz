...
poly = genTreeEnv(num_rooms, rvx, rooms, corridors, tree_map, Hallway_Type.RANDOM_DIRECTION)
...
if unreach_segs != []:
    ...
    visualize_subset_polygon(ins_vs, "reachable_boundary_hobbit", unreach_segs)
