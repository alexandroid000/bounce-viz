...
We consider the movement of a point robot in simple polygonal environments. All index arithmetic for polygons with $n$ vertices is mod $n$ 
...
%\end{subfigure}
\caption{An example partition for a polygon with holes.}
\label{fig:bvd_holes}
\end{figure}
...
$\tilde{\theta}$ intervals, and returns the successful $\tilde{\theta}$ or that
...
contraction coefficient is less than one. We sketch here how to begin searching
this space of cycles to solve various robotic tasks, such as \emph{patrolling}:
