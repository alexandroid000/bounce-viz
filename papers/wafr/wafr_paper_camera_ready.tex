...
position.
\footnote{Software implementation at
...
Lemma \ref{lem:action} holds because the geometric condition in Proposition \ref{prop:saferange} must hold in one
...
%    \caption{Angle range such that a safe transition exists for all points on
