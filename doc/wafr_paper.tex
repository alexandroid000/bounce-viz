...
et $P'$ be the polygon $P$ with all partial local sequence points inserted.
...
\ref{fig:regular_pent_bvd} for examples. The diagram gives us
some visual insight into the structure of the problem - for example, certain
transitions cannot be accomplished with a single $\theta$ from anywhere on the
originating segement.
