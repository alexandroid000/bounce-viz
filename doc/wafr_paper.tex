...
segment-to-segment transitions under ranges of departure angles. {\color{red}
point out examples of safe and unsafe transitions, and possible cycles at "clear
intervals"}
...
\centering
\includegraphics[width=\linewidth]{figures/L_poly.jpg}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
\includegraphics[width=\linewidth]{figures/L_diagram.jpg}
\end{subfigure}
...
\end{theorem}
\begin{proof}
{\color{red} shorten, make notation consistent with rest of paper}
