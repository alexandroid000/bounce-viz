...
Specifically, the existence of an edge $e_{ij} \in E(G)$ implies that from any point $x$ in the
segment $i$, there exists a range of departure angles
$\tilde{\theta}$ such that $f(x,\theta) \in j$.
\end{lemma}
