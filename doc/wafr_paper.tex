...
\begin{definition}
A \textbf{bounce law} is a function which returns the outgoing heading vector of
the robot. It is a function of the robot's incoming heading (the vector $v_i$)
...
state indicates a certain bounce law, and the input language is that of the
