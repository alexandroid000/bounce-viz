...
More formally, our modle of the robot includes:
...
It is a function of the robot's incoming heading (the angle $\alpha$)
and a control parameter $\theta$. We specify bounce laws in the
