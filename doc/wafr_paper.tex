...
\authorrunning{A. Nilles, Y. Ren, I. Becerra, S. LaValle} % abbreviated author list (for running head)
...
A path which undergoes
transitions $f_1, \ldots, f_k$ can be represented as the composition of each
