...
\end{definition}
%%S I don't understand what extended to infinity has to do with the def.  Isn't angle local?
...
\end{definition}
%%S I am afraid to make changes this late, but shouldn't right be emphasized above?  In a definition, it is common to italicize the defined thing.  And if it is all italicised in this strange style, then it should get unitalicized.
...
\textbf{Obstacles. } There is no reason that Algorithm \ref{algo:insert} and the 
