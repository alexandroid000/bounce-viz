...
\section{Visibility-Based Boundary Partitioning}
...
was inspired by link diagrams {\color{red} cite}.
...
properties of families of paths the robot may take. For example, the following two paths are produced by different bounce
strategies, but can be deformed into each other by sliding collision points
without crossing a vertex of $P$.
